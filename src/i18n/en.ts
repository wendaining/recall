export const en = {
  ...
  story: {
    ...
    scrollCue: 'SCROLL TO PLAY · SCROLL UP TO REWIND',
    steps: [
      {
        number: '01',
        eyebrow: 'CAPTURE',
  ...
  demo: {
    title: 'recall / interface preview',
    path: '~/Projects/recall',
    capture: {
      shell: 'zsh · session 04',
      command: 'cargo test',
      output: [
        '   Compiling recall v0.1.0',
        '    Finished `test` profile',
        '     Running unittests src/main.rs',
        '',
        'running 14 tests',
        'test capture::marker::parse ... ok',
        'test capture::classifier::text ... ok',
        'test capture::secrets::redact ... ok',
        'test db::queries::insert ... ok',
        'test db::queries::search ... ok',
        'test db::schema::migrate ... ok',
        'test config::read ... ok',
        'test shell::detect ... ok',
        'test clipboard::copy ... ok',
        'test tui::selection ... ok',
        'test tui::search ... ok',
        'test import::history ... ok',
        'test platform::proxy ... ok',
        'test util::format ... ok',
        '',
      ...
      duration: '1.8s',
      exit: 'exit 0',
      caption: 'Command, output, and context—together.',
    },
    search: {
      title: 'recall — search',
      launchCommand: 'recall',
      query: 'migration',
      count: '3 matching blocks',
      firstCommand: 'cargo test db::migration',
      firstPreview: 'test db::migration::v4 ... ok',
      secondCommand: 'rg migration src/db',
      secondPreview: 'src/db/schema.rs: apply_migrations()',
      thirdCommand: 'git log --oneline',
      thirdPreview: 'c329ab7 fix: handle migration rollback',
      hint: 'Search matches commands and output',
    },
    inspect: {
      title: 'recall — block detail',
      command: 'cargo test db::migration',
      labelOutput: 'OUTPUT',
      output: ['running 3 tests', 'test db::migration::v2 ... ok', 'test db::migration::v3 ... ok', 'test db::migration::v4 ... ok', 'test result: ok. 3 passed'],
      labelCwd: 'DIRECTORY',
      labelTime: 'RAN AT',
    ...
    continue: {
      title: 'recall — ready to continue',
      selected: 'SELECTED COMMAND',
      command: 'cargo test db::migration',
      prompt: 'Command returned to your prompt for editing',
      edit: 'Tab  edit command',
      run: 'Ctrl+E  rerun',
      copyCommand: 'Ctrl+Y  copy command',
      copyOutput: 'Ctrl+O  copy output',
      hint: 'Choose how to continue',
      output: [
        '     Running tests/db_migration.rs',
        '',
        'running 3 tests',
        'test db::migration::v2 ... ok',
        'test db::migration::v3 ... ok',
        'test db::migration::v4 ... ok',
        '',
